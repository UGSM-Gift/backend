...
import com.ugsm.secretpresent.service.RandomNicknameService
...
class UserController(
    ...
    @Autowired
    val randomNicknameService: RandomNicknameService
) {
    ...
    fun getRandomNickname(): ResponseEntity<CustomResponse<String>> {
        val randomNickname = randomNicknameService.getAutoGeneratedNickname()
        return ResponseEntity.ok(
            CustomResponse(
                GlobalResCode.OK.code,
                randomNickname,
